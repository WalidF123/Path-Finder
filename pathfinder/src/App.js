...
function App() {
	...
	useEffect(() => {
		...
		const close_drop_down = (e) => {
			...
			const clicked_className = e.composedPath()[0].className
		...
		<>
			...
			<div className="nav_container">
				...
				<nav id="nav_bar">
					...
					<div className="nav_col_1 nav_col">
					...
					<div className="nav_col_2 nav_col">
						...
						<div className="all_drop_downs">
							<div className="search_drop_down drop_down_div">
								...
								>
									...
									<img src="./images/dropdown-arrow.png" alt="V" />
								</button>
					...
					<div className="nav_col_3 nav_col">
						<div className="cell_types_with_heading">
							<h4>Hello</h4>
